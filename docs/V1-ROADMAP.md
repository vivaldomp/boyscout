...
| **SP7** | **Parallel Execution** (D8) | `planner`/`runtime` parallel scheduler + deterministic reassembly | SP2 | Parallel output **byte-identical to sequential** baseline; measurable speedup |
