...
// ponytail: flat merge assumes no filename collisions across bridges (true today,
// verified pre-build) — namespace by bridge if a future bridge's template name clashes.
for (const dir of [
